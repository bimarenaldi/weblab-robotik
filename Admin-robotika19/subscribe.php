        ...
        <div id="page-wrapper" >
		 ...
		 <div class="tab-content">
			...
			if (isset($_POST['btn_isi'])) { 
					...
					mysqli_query($db, "UPDATE tb_about SET isi='$txt_isi1' WHERE id=4")or die (mysql_error());
			}
				 include('koneksi.php'); // Koneksi ke database
				$sql = mysqli_query($db,"SELECT * FROM tb_subscribe order by id ASC");
				...
				echo "
                                    ...
                                    <tr class='warning'>
										...
										<td>".$data['tanggal']."</td>
										<td>".$data['email']."</td>
										<td><a href='delete_subs.php?id=".$data['id']."'>HAPUS</a></td>
                                    </tr>";
				...
				<input type="submit" name="btn_copy" class="btn btn-primary" value="Copy Semua Email"><br>
				</form>
			<?php
			...
			?>	
				<input class="form-control" name="rec_id" placeholder="Tempat Email" value='<?php echo $a; ?>'/><br>
				<p>TINGGAL CRTL+A LALU COPY KE GMAIL</p>
			<?php
				}
			?>
