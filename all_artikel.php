        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> 
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main_nav">
              <li class="active"><a href="#">All Artikel</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <!-- START BLOG HEADING -->
            <div class="heading">
              <h2 class="wow fadeInLeftBig">Kumpulan Artikel</h2>
            </div>
          </div>
            <!-- BEGAIN BLOG CONTENT -->
			  ...
			  <?php
			   include('admin-robotika19/koneksi.php');			  
				...
				$sql = "SELECT * FROM tb_artikel ORDER BY ID DESC LIMIT $posisi,$batas";
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  ...
                  <div class="post_commentbox">
                    ...
                    <a href="artikel.php?id=<?php echo $row['id'] ?>" class="read_more">Read More <i class="fa fa-angle-double-right">  </i></a><br><br><br>                 
                  </div>
				...
				<div class="pagination">
					<?php
						...
						if ($i != $halaman){
							...
							echo "<a class='page-numbers ' href=\"all_artikel.php?halaman=$i\">$i</a> ";
						}
						else{ 
